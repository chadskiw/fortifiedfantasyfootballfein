...
// utils/identity.js
async function getCurrentIdentity(req, pool) {
  // If middleware already populated it:
  ...
  // Fallback: use memberId as handle
  return {
    memberId,                      // <<< add this
    handle: memberId,
    hue: null
