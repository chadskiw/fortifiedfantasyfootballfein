...
// make sure `router` is your Express.Router() instance
module.exports = router;        // CommonJS default
module.exports.router = router; // named export compatibility
module.exports.default = router; // ESM default compatibility
